...
- Missing comments for most frontend code and some backend code
...
Deduct 0.1 points for each standup missed for up to 0.5 point in total.
  ...
  Daily Stand-ups Total Mark: __ / 3
