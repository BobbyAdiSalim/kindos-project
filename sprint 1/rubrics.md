...
---
## Planning Meetings (RPM.md, product01.md) (max 10 marks)
...
Your Mark: 5
  ...
  - Sprint Planning meeting (product01.md) (max 5 marks)
...
Note: a completed sprint may be hidden from the Backlog/Board.
...
- Need to understand better about the technongies they are using
- Better DB mangement
- 7
